...
docker run --rm -d --network host --privileged --name nomachine-xfce4 -e PASSWORD=264726 -e USER=Hashir --cap-add=SYS_PTRACE --shm-size=1g thuonghai2711/nomachine-ubuntu-desktop:windows10
clear
